...
function renderGraph(target, spec) {
  ...
  el.innerHTML = `<div class="graph-shell"><svg class="graph-svg" preserveAspectRatio="none"></svg><div class="graph-legend" aria-hidden="true"></div><div class="graph-tooltip" hidden></div></div>`;
